function clearAll() {
    document.querySelector('.meme-content').innerHTML='';
    document.querySelector('.joke-content').innerHTML='';
    document.querySelector('.wisdom-content').innerHTML='';
    document.querySelector('.riddle-content').innerHTML='';
  ...
  */
  function showMeme() {
    ...
    const container_meme = document.querySelector('.meme-content');
    const newElement_meme = document.createElement('img');
    newElement_meme.setAttribute('src',randomMemeUrl);
      clearAll();
    container_meme.append(newElement_meme);
  }
  /**
  * TODO: 
  ...
  */
  function showJoke() {
    ...
    clearAll();
    jokeContainer.append(jokeElement);
  }
  ...
  */
  function showQuote() {
    ...
    clearAll();
    document.querySelector('.wisdom-content').append(quote);
    document.querySelector('.wisdom-content').append(author);
  ...
  */
  function showRiddle() {
    ...
    answer.setAttribute('class','answer_riddle');
    ...
    clearAll();
    document.querySelector('.riddle-content').append(question);
    document.querySelector('.riddle-content').append(answer);  
  ...
  */
  function revealAnswers() {
    const question = document.querySelector('.riddle-content').querySelector('p');
    const answer = document.querySelector('.answer_riddle');
